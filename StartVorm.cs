...
namespace Elemendid_vormis_TARpv23
{
    ...
    {
        List<string> elemendid = new List<string> { "Nupp", "Silt", "Pilt", "Märkeruut", "Raadionupp", "Tekstikast", "Loetelu", "Tabel", "Dialoogi aknad", "TeineVorm", "Picture_Viewer" };
        ...
        private void Tree_AfterSelect(object? sender, TreeViewEventArgs e)
        {
            ...
            else if (e.Node.Text == "Picture_Viewer")
            {
                Picture_Viewer picture_Viewer = new Picture_Viewer(400, 400);
                picture_Viewer.Show();
            }
